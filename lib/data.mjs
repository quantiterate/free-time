...
export const personas = {
  ...
  priya: {
    id: "priya",
    name: "Priya",
    summary: "Affordable, accessible outings with moderate activity, manageable crowds, and room to try something new.",
    hardConstraints: ["wheelchair_access","accessible_restroom","no_alcohol_centered"],
    maxWalkingMiles: 1.2,
    preferredDriveMinutes: 20,
    preferredIntensity: "medium",
    requiresSeating: false,
    noiseTolerance: "medium",
    crowdTolerance: "medium",
    prefersPredictable: false,
    categories: ["garden","library","craft"],
    dislikes: ["bar","high_intensity_sport"],
    noveltyPreference: "novel",
    vector: [0.6,0.65,0.7,0.9,0.55,0.45]
  }
};
...
export const candidates = [
  ...
  {
    id:"botanical-garden", title:"Community Botanical Garden", category:"garden",
    social:"Together", setting:"Outside", costClass:"Free",
    outboundMinutes:15, activityMinutes:65, returnMinutes:15,
    walkingMiles:0.9, intensity:"medium", noiseLevel:"low", crowdLevel:"medium",
    flashingLights:false, petFriendly:true, reliableSeating:true,
    wheelchairAccessible:true, accessibleRestroom:true, parkingNearEntrance:true,
    alcoholCentered:false, predictable:true, cardAccepted:true,
    novelty:"novel", confidence:"high",
    facts:["Paved garden loop","Frequent benches","Accessible restroom","Leashed pets welcome"]
  },
  {
    id:"library-nook", title:"Neighborhood Library Reading Nook", category:"library",
    social:"Alone", setting:"Inside", costClass:"Free",
    outboundMinutes:8, activityMinutes:80, returnMinutes:8,
    walkingMiles:0.08, intensity:"low", noiseLevel:"low", crowdLevel:"low",
    flashingLights:false, petFriendly:false, reliableSeating:true,
    wheelchairAccessible:true, accessibleRestroom:true, parkingNearEntrance:true,
    alcoholCentered:false, predictable:true, cardAccepted:true,
    novelty:"familiar", confidence:"high",
    facts:["Quiet designated area","Adjustable seating","Step-free entrance","Free admission"]
  },
  {
    id:"makers-workshop", title:"Beginner Pottery Workshop", category:"craft",
    social:"Together", setting:"Inside", costClass:"Pay",
    outboundMinutes:16, activityMinutes:70, returnMinutes:16,
    walkingMiles:0.2, intensity:"medium", noiseLevel:"medium", crowdLevel:"low",
    flashingLights:false, petFriendly:false, reliableSeating:true,
    wheelchairAccessible:true, accessibleRestroom:true, parkingNearEntrance:false,
    alcoholCentered:false, predictable:true, cardAccepted:true,
    novelty:"novel", confidence:"medium",
    facts:["Small class size","Seated workstations","Step-free studio","Materials included"]
  },
  {
    id:"farmers-market", title:"Riverside Farmers Market", category:"market",
    social:"Together", setting:"Outside", costClass:"Free",
    outboundMinutes:12, activityMinutes:60, returnMinutes:12,
    walkingMiles:1.1, intensity:"medium", noiseLevel:"medium", crowdLevel:"high",
    flashingLights:false, petFriendly:true, reliableSeating:false,
    wheelchairAccessible:true, accessibleRestroom:false, parkingNearEntrance:false,
    alcoholCentered:false, predictable:false, cardAccepted:false,
    novelty:"novel", confidence:"medium",
    facts:["No admission fee","Leashed pets welcome","Uneven vendor payment options","Crowds vary by hour"]
  },
  {
    id:"jazz-lounge", title:"Downtown Jazz Lounge", category:"bar",
    social:"Together", setting:"Inside", costClass:"Pay",
    outboundMinutes:18, activityMinutes:65, returnMinutes:18,
    walkingMiles:0.3, intensity:"low", noiseLevel:"high", crowdLevel:"high",
    flashingLights:true, petFriendly:false, reliableSeating:true,
    wheelchairAccessible:false, accessibleRestroom:false, parkingNearEntrance:false,
    alcoholCentered:true, predictable:false, cardAccepted:true,
    novelty:"novel", confidence:"low",
    facts:["Live music","Drink minimum","Limited seating reservations","Venue details may change"]
  }
];
